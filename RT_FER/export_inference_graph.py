...
tf.app.flags.DEFINE_string(
    'model_name', 'mobilenet_v1', 'The name of the architecture to save.')
...
tf.app.flags.DEFINE_string('dataset_name', 'ck_plus',
                           'The name of the dataset to use with the model.')

tf.app.flags.DEFINE_string('preprocessing_name', 'mobilenet_v1',
                           'The name of the dataset to use with the model.')
...
def main(_):
  ...
  with tf.Graph().as_default() as graph:
    ...
    '''
    #Image Preprocessing:
    image = image_processing_fn(placeholder, image_size, image_size)
