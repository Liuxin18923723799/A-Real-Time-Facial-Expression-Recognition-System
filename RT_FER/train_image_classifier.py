...
tf.app.flags.DEFINE_string(
    'dataset_name', 'ck_plus', 'The name of the dataset to load.')
...
tf.app.flags.DEFINE_integer(
    'train_image_size', 48, 'Train image size')
  ...
  with tf.Graph().as_default():
    ...
    def clone_fn(batch_queue):
      ...
      if FLAGS.center_loss is True:
          ...
          c_loss, centers, centers_update_op = center_loss.get_center_loss(feature,
                                                                           labels_argmax, 0.001, 6,
                                                                           name_scope='AvgPool_1a_center')
          c_loss = 0.001 * c_loss
    ...
    ##################################################
    # Calculate the averaged accuracy for all clones #
    ##################################################
    ...
    #Define saver to keep more stages:
    ###########################
